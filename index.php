...
_Hasync.push(['Histats.start', '1,5019164,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5019164&101" alt="hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->
    <meta charset="utf-8">
    <title>Xenon Design</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h5>FREE TEMPLATES by templatemo.com</h5>
                    <p>Xenon Design is free website template by templatemo. <strong>Xenon</strong> is a responsive Bootstrap HTML5 layout that is available to download, edit and use for any website. Credits go to <a rel="nofollow" href="http://www.smashingmagazine.com/2012/11/20/art-professions-icons-png/">Art Professions</a> Icon Set by Smashing Magazine and <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for images used in this template. 
                    <br><br>You can remove anything from this 100% free template. You do not need to provide a credit link to templatemo.</p>
    ...
    <div id="bottom-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left-one text-center">
                        <h1>IDEAS <em>COME</em> FROM YOUR <em>MIND</em></h1>
                        <div class="image-holder">
                ...
                <div class="col-md-6">
                    <div class="right-one">
                        ...
                        <div class="text-left">
                            ...
                            <ul>
                                <li>Quisque cursus mi nunc quis mollis justo suscipit sed.</li>
                                <li>Etiam dapibus ante a nisl euismod vitae tristique nunc vehicula.</li>
                                <li>In consequat ligula sit amet fermentum luctus.</li>
                                <li>Cras dignissim posuere dolor eget mollis aliquam erat volutpat.</li>
                                <li>Nullam aliquet euismod elementum elit tincidunt ac bibendum.</li>
                                <li>Pellentesque in tellus pharetra lobortis nunc.</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-4">
                    <div class="video-holder text-center">
                        <h3>Australia's Gold Coast Video</h3>
                        <iframe src="http://player.vimeo.com/video/103076330" width="853" height="430" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
        <div class="container" id="contact">
            ...
            <div class="row">
                <div class="col-md-9">
                	<h3>321 Thamine Street, Digital Estate, Yangon 10110, Myanmar</h3>
